...
function MoreButton({ toggleShowMore }) {
const [rotate, setRotate] = useState(270);

const handleClick = () => {
    setRotate(rotate === 270 ? 90 : 270);
    toggleShowMore();
}

    return (
        <motion.svg onClick={handleClick} animate={{ rotate }} transition={{ type: "keyframes", duration: 0.1 }} className="showMoreBtn" width="40px" height="40px" viewBox='0 0 24 24'>
